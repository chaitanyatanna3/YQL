...
public class Downloader extends AsyncTask<String , Integer, ArrayList> {
    ...
    public Downloader(ResultsActivity activity) {
        this.resultsActivity = activity;
    }

    @Override
    protected void onPreExecute() {
        super.onPreExecute();
        resultsActivity.displayProgressBar();
    }
    ...
    protected ArrayList doInBackground(String... params) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                Results result = new Results(title, address, city, state, phone, longitude, latitude, distance, businessURL);
    ...
    protected void onProgressUpdate(Integer... values) {
        ...
        resultsActivity.setProgressBarProgress(values[0]);
    }

    @Override
    protected void onPostExecute(ArrayList arrayList) {
        super.onPostExecute(arrayList);
        resultsActivity.drawListView(arrayList);
    }
}
